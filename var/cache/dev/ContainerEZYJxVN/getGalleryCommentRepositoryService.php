...
// Returns the private 'App\Repository\GalleryCommentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/GalleryCommentRepository.php';

return $this->privates['App\\Repository\\GalleryCommentRepository'] = new \App\Repository\GalleryCommentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
