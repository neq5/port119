...
// Returns the private 'App\Repository\AlbumARepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AlbumARepository.php';

return $this->privates['App\\Repository\\AlbumARepository'] = new \App\Repository\AlbumARepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
