...
// Returns the private 'App\Repository\UserDataRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserDataRepository.php';

return $this->privates['App\\Repository\\UserDataRepository'] = new \App\Repository\UserDataRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
