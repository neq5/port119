...
// Returns the private 'App\Repository\ProfileVisitsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProfileVisitsRepository.php';

return $this->privates['App\\Repository\\ProfileVisitsRepository'] = new \App\Repository\ProfileVisitsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
