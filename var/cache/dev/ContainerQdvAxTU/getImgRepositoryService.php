...
// Returns the private 'App\Repository\ImgRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ImgRepository.php';

return $this->privates['App\\Repository\\ImgRepository'] = new \App\Repository\ImgRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
