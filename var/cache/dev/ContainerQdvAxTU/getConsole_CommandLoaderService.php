...
}, 'doctrine_migrations.current_command' => function (): \Doctrine\Migrations\Tools\Console\Command\CurrentCommand {
    return ($this->privates['doctrine_migrations.current_command'] ?? $this->load('getDoctrineMigrations_CurrentCommandService.php'));
}, 'doctrine_migrations.diff_command' => function (): \Doctrine\Migrations\Tools\Console\Command\DiffCommand {
    return ($this->privates['doctrine_migrations.diff_command'] ?? $this->load('getDoctrineMigrations_DiffCommandService.php'));
}, 'doctrine_migrations.dump_schema_command' => function (): \Doctrine\Migrations\Tools\Console\Command\DumpSchemaCommand {
...
}, 'doctrine_migrations.execute_command' => function (): \Doctrine\Migrations\Tools\Console\Command\ExecuteCommand {
    return ($this->privates['doctrine_migrations.execute_command'] ?? $this->load('getDoctrineMigrations_ExecuteCommandService.php'));
}, 'doctrine_migrations.generate_command' => function (): \Doctrine\Migrations\Tools\Console\Command\GenerateCommand {
    return ($this->privates['doctrine_migrations.generate_command'] ?? $this->load('getDoctrineMigrations_GenerateCommandService.php'));
}, 'doctrine_migrations.latest_command' => function (): \Doctrine\Migrations\Tools\Console\Command\LatestCommand {
    return ($this->privates['doctrine_migrations.latest_command'] ?? $this->load('getDoctrineMigrations_LatestCommandService.php'));
}, 'doctrine_migrations.migrate_command' => function (): \Doctrine\Migrations\Tools\Console\Command\MigrateCommand {
    return ($this->privates['doctrine_migrations.migrate_command'] ?? $this->load('getDoctrineMigrations_MigrateCommandService.php'));
}, 'doctrine_migrations.rollup_command' => function (): \Doctrine\Migrations\Tools\Console\Command\RollupCommand {
    return ($this->privates['doctrine_migrations.rollup_command'] ?? $this->load('getDoctrineMigrations_RollupCommandService.php'));
}, 'doctrine_migrations.status_command' => function (): \Doctrine\Migrations\Tools\Console\Command\StatusCommand {
    return ($this->privates['doctrine_migrations.status_command'] ?? $this->load('getDoctrineMigrations_StatusCommandService.php'));
}, 'doctrine_migrations.sync_metadata_command' => function (): \Doctrine\Migrations\Tools\Console\Command\SyncMetadataCommand {
    return ($this->privates['doctrine_migrations.sync_metadata_command'] ?? $this->load('getDoctrineMigrations_SyncMetadataCommandService.php'));
}, 'doctrine_migrations.up_to_date_command' => function (): \Doctrine\Migrations\Tools\Console\Command\UpToDateCommand {
    return ($this->privates['doctrine_migrations.up_to_date_command'] ?? $this->load('getDoctrineMigrations_UpToDateCommandService.php'));
}, 'doctrine_migrations.version_command' => function (): \Doctrine\Migrations\Tools\Console\Command\VersionCommand {
    return ($this->privates['doctrine_migrations.version_command'] ?? $this->load('getDoctrineMigrations_VersionCommandService.php'));
}, 'doctrine_migrations.versions_command' => function (): \Doctrine\Migrations\Tools\Console\Command\ListCommand {
    return ($this->privates['doctrine_migrations.versions_command'] ?? $this->load('getDoctrineMigrations_VersionsCommandService.php'));
