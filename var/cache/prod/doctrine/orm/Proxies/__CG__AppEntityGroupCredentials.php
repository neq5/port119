 ...
 */
class GroupCredentials extends \App\Entity\GroupCredentials implements \Doctrine\ORM\Proxy\Proxy
{
    /**
  ...
  'accounts' => NULL,
    ...
    {
        unset($this->groups, $this->accounts);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\GroupCredentials' . "\0" . 'id', 'groups', 'accounts'];
        }

        return ['__isInitialized__', '' . "\0" . 'App\\Entity\\GroupCredentials' . "\0" . 'id'];
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GroupCredentials $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setGroups($groups): \App\Entity\GroupCredentials
    {
     ...
     * {@inheritDoc}
     */
    public function setAccounts($accounts): \App\Entity\GroupCredentials
    {
