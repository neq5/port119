 ...
 */
class Gallery2 extends \App\Entity\Gallery2 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Gallery2' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Gallery2' . "\0" . 'brochure', '' . "\0" . 'App\\Entity\\Gallery2' . "\0" . 'image', '' . "\0" . 'App\\Entity\\Gallery2' . "\0" . 'imageFile', '' . "\0" . 'App\\Entity\\Gallery2' . "\0" . 'updatedAt', '' . "\0" . 'App\\Entity\\Gallery2' . "\0" . 'todelete'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Gallery2 $proxy) {
