...
// Returns the private 'App\Repository\GroupVistsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/GroupVistsRepository.php';

return $this->privates['App\\Repository\\GroupVistsRepository'] = new \App\Repository\GroupVistsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
