...
// Returns the private 'App\Repository\HitsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/HitsRepository.php';

return $this->privates['App\\Repository\\HitsRepository'] = new \App\Repository\HitsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
