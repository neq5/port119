...
// Returns the private 'App\Repository\WallRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/WallRepository.php';

return $this->privates['App\\Repository\\WallRepository'] = new \App\Repository\WallRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
