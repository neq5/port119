...
// Returns the private 'App\Repository\Gallery2Repository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/Gallery2Repository.php';

return $this->privates['App\\Repository\\Gallery2Repository'] = new \App\Repository\Gallery2Repository(($this->services['doctrine'] ?? $this->getDoctrineService()));
