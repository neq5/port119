...
// Returns the private 'App\Repository\GroupCredentialsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/GroupCredentialsRepository.php';

return $this->privates['App\\Repository\\GroupCredentialsRepository'] = new \App\Repository\GroupCredentialsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
