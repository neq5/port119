...
// Returns the private 'App\Repository\Content2Repository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/Content2Repository.php';

return $this->privates['App\\Repository\\Content2Repository'] = new \App\Repository\Content2Repository(($this->services['doctrine'] ?? $this->getDoctrineService()));
