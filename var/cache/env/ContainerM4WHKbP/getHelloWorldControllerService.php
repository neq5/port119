...
return $this->services['App\\Controller\\HelloWorldController'] = new \App\Controller\HelloWorldController(($this->services['knp_paginator'] ?? $this->load('getKnpPaginatorService.php')));
