...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/connect/facebook'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/jq$'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/top'), [0 => 'ROLE_USER'], NULL);
