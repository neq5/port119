...
class srcEnvDebugProjectContainer extends Container
{
    ...
    protected function getTranslatorService()
    {
        ...
        $instance->setConfigCacheFactory(($this->privates['config_cache_factory'] ?? $this->getConfigCacheFactoryService()));
        $instance->setFallbackLocales([0 => 'pl', 1 => 'pl']);
    ...
    protected function getTwigService()
    {
        ...
        $d = new \ArturDoruch\FlashMessageBundle\Templating\Helper\FlashMessageHelper();
        $d->setMessageClassNames([]);
        ...
        $instance->addExtension(new \ArturDoruch\FlashMessageBundle\Twig\Extension\FlashMessageExtension(($this->services['session'] ?? $this->getSessionService()), $d));
