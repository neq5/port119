...
// Returns the private 'App\Repository\SubscriptionsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SubscriptionsRepository.php';

return $this->privates['App\\Repository\\SubscriptionsRepository'] = new \App\Repository\SubscriptionsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
