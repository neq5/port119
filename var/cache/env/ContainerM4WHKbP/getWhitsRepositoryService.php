...
// Returns the private 'App\Repository\WhitsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/WhitsRepository.php';

return $this->privates['App\\Repository\\WhitsRepository'] = new \App\Repository\WhitsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
