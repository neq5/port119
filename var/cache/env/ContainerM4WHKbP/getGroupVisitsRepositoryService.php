...
// Returns the private 'App\Repository\GroupVisitsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/GroupVisitsRepository.php';

return $this->privates['App\\Repository\\GroupVisitsRepository'] = new \App\Repository\GroupVisitsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
